...
| secrets | The list of the secrets | <pre>list(object({<br>    name : string,<br>    secret_data : optional(string),<br>    next_rotation_time : optional(string),<br>    rotation_period : optional(string),<br>    create_version : optional(bool, true),<br>    labels : optional(map(string)),<br>    iam_bindings : optional(list(object({<br>      role    = string,<br>      members = list(string)<br>    })))<br>  }))</pre> | `[]` | no |
