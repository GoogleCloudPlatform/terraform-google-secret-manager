...
| secret\_deletion\_policy | The deletion policy for the secret version. Possible values are "ABANDON", "DELETE", and "DISABLE". Defaults to "DELETE". | `string` | `"DELETE"` | no |
