...
| secrets | The list of the secrets | <pre>list(object({<br>    name : string,<br>    location : string,<br>    secret_data : optional(string),<br>    next_rotation_time : optional(string),<br>    rotation_period : optional(string),<br>    create_version : optional(bool, true)<br>    customer_managed_encryption : optional(string),<br>  }))</pre> | `[]` | no |
